...
export function RunStepFeed({ running, steps, className }: Props) {
  ...
  // Nothing to log between runs: the surfaces this feed sits on (the ring, the
  // build preview's dock) are there to report work in flight, and a resting
  // line of copy in either of them reads as a caption on the animation.
