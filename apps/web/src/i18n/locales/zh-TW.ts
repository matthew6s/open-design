...
export const zhTW: Dict = {
  ...
  "chat.runError.title.clarificationRepeated": "智能體又問了一個問題",
  ...
  "chat.runError.signInMessage.amr":
    "OpenDesign Cloud 智能體尚未登入，前往登入即可正常使用",
  "chat.runError.signInMessage.other":
    "{agent}尚未登入，請在本機檢查登入狀態。推薦使用 OpenDesign Cloud 智能體，更穩定划算",
  "chat.runError.agentFallback": "智能體",
  "chat.runError.sourceLabel": "查看錯誤詳情",
  "chat.runError.sourceExpandAria": "展開錯誤原始碼",
  "chat.runError.sourceCollapseAria": "收合錯誤原始碼",
  "chat.runError.title.cliMissing": "智能體尚未安裝",
  ...
  "chat.runError.membershipConcurrencyLimitMessage": "目前會員的並行任務已滿。請等到 {retryAt} 後重試，或切換到其他智能體；立即重試不會恢復。",
  "chat.runError.membershipConcurrencyLimitMessageNoTime": "目前會員的並行任務已滿。請等待其他任務結束後重試，或切換到其他智能體；立即重試不會恢復。",
  ...
  "chat.runError.runtimeConfigMessage": "所選智能體的執行階段設定有誤，無法啟動本輪任務。請更新到最新版本或聯絡支援。",
  ...
  "chat.runError.title.cliSessionRefused": "智能體版本不相容",
  ...
  "chat.runError.title.agentCrashed": "智能體意外結束",
  ...
  "chat.runError.agentReplyIncompleteMessage": "智能體的回覆裡缺少 Open Design 記錄這一步所需的標記，任務因此沒能繼續。你提交的內容沒有遺失；這屬於偶發情況，重試一次通常就好了。",
  "chat.runError.clarificationRepeatedMessage": "智能體還想再確認一些資訊，於是又問了一次；但一個任務只允許一輪提問，所以停在了這裡。你的回答仍然保留在對話裡——重試會把請求重新跑一遍，把要補充的資訊一起寫進去，通常一輪就能問清楚。",
  ...
  "settings.modeDaemonHelp": "透過本機的程式碼智能體 CLI 執行",
  ...
  "settings.agentInstall.stepOpenLinks":
    "在目標智能體卡片上開啟「安裝」或「文件」連結。",
  "settings.agentInstall.stepAuth":
    "返回 OpenDesign 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。",
  "settings.agentInstall.stepRescan": "在此區域點擊「重新掃描」。",
  "settings.agentInstall.stepSelect": "當智能體顯示為已安裝後，選擇該智能體卡片。",
  "settings.noAgentsDetected":
    "尚未偵測到任何智能體。請安裝 Claude Code、Codex、OpenCode、Cursor Agent 或 Qwen 其中之一，然後點擊「重新掃描」。",
  ...
  "settings.noAgentSelected": "尚未選擇智能體",
  ...
  "settings.mcpServerHint":
    "將 OpenDesign 作為 MCP 伺服器暴露給你的編碼智能體。",
  ...
  "routines.emptyHint": "點選「新增自動化」即可安排一次無人值守的智能體執行。",
  ...
  "routines.errorAgentEmptyOutput":
    "智能體已完成執行但未產生任何輸出。模型或提供商可能返回了空回應，請檢查智能體日誌中的上游錯誤。",
  ...
  "connectors.category.aiAgents": "AI 智能體",
  ...
  "newproj.dsNoneSubtitleSelected": "跳過系統 token，由智能體自行選擇配色。",
  ...
  "newproj.dsNoneSub": "跳過系統 token，由智能體自行選擇配色。",
  ...
  "avatar.noAgentSelected": "尚未選擇智能體",
  ...
  "designFiles.usefulInfoTip9":
    "把圖片、文件甚至整個資料夾拖到目前面板，智能體都會用作上下文。",
  "designFiles.usefulInfoTip10":
    "點「新建草圖」手繪一個版面，讓智能體照著生成。",
  "designFiles.usefulInfoTip11":
    "在預覽中圈選任意元素發表評論，智能體會針對性修改。",
  ...
  "fileViewer.exportPptxHint": "請求智能體將此設計轉換為 PPTX。",
  ...
  "assistant.statusBootingAgent": "正在啟動智能體",
  ...
  "qf.ownAnswer": "自己填",
  "qf.required": "必填",
  "qf.lockedSubmitted": "答案已傳送，智能體將在本次工作階段後續使用。",
  "qf.lockedPrev": "該表單來自先前的對話。",
  "qf.hint": "挑選合適的選項；可選項可以跳過，智能體會使用合理的預設值。",
  ...
  "critiqueTheater.failedReasonCliExit": "智能體 CLI 在評審完成前異常結束。",
  ...
  "critiqueTheater.settingsNavHint": "為智能體執行啟用五人設計評審",
  "critiqueTheater.settingsEnabledLabel": "在智能體執行期間顯示設計評審團",
  "critiqueTheater.settingsEnabledDescription":
    "啟用後，五人評審面板會在智能體產生時同步進行，並在交付前為結果評分。可隨時中斷。",
  ...
  "settings.skills": "技能",
  "settings.skillsHint": "智能體可在任務中呼叫的功能技能",
  ...
  "settings.memoryProfileHint":
    "關於你和你預設偏好的幾項資訊。記憶會在每次任務前注入這些內容，讓智能體能從簡短的需求推斷你的意圖。",
  ...
  "mcpClient.notForwardedNote":
    "對於這些智能體，請在其各自的設定檔中設定 MCP 伺服器（例如 ~/.codex/config.toml、~/.gemini/settings.json）；下方的伺服器在那裡不會生效。",
  ...
  'library.sync': '同步',
  'library.syncing': '同步中…',
  'library.syncTooltip': '將你的設計系統與智能體產生的成果拉取到素材庫',
  'library.upload': '上傳',
  ...
  'mcp.categoryWebCaptureHint': '把 URL 算繪成圖片，讓智能體看到自己做出來的東西。',
  'mcp.checking': '檢查中…',
  ...
  'dsCreate.githubComposioDefaultDesc': '為智能體工具提供 Composio GitHub 連接器存取；儲存庫連結仍可透過本機 git 或 GitHub CLI 使用。',
  ...
  'dsFlow.pickLocalAgentFirst': '請先選擇一個本機智能體，然後讓 OpenDesign 更新這個設計系統。',
