...
export const fa: Dict = {
  ...
  'chat.amrBalanceGate.benefit2': 'عامل طراحی SOTA داخلی، بدون پیکربندی',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'شما از عامل OpenDesign Cloud استفاده می‌کنید — وارد شوید تا این وظیفه بلافاصله شروع شود.',
  ...
  'newproj.promptTemplateOptimizeHint': 'هر چیزی را می‌توانید ویرایش کنید — تغییرات شما به بریف عامل اضافه می‌شود.',
  'newproj.promptTemplateBodyEmpty': 'متن خالی است — عامل هیچ مرجع قالبی دریافت نمی‌کند.',
  ...
  'critiqueTheater.failedReasonCliExit': 'CLI عامل پیش از پایان کار پنل با کد غیرصفر خارج شد.',
  ...
  'critiqueTheater.settingsEnabledLabel': 'نمایش هیئت داوران طراحی در حین اجرای عامل',
  'critiqueTheater.settingsEnabledDescription': 'وقتی فعال باشد، یک بررسی پنج‌پنلی در کنار تولیدات عامل ظاهر می‌شود و پیش از انتشار به خروجی امتیاز می‌دهد. می‌توانید هر زمان آن را متوقف کنید.',
  ...
  'pet.taskSummarySingle': '{count} وظیفه عامل در حال اجراست.',
  'pet.taskSummaryMultiple': '{count} وظیفه عامل در {projects} پروژه در حال اجراست.',
  'pet.taskSummaryRecentSingle': '{count} وظیفه عامل اخیراً تکمیل شد.',
  'pet.taskSummaryRecentMultiple': '{count} وظیفه عامل اخیراً تکمیل شدند.',
  'pet.taskListAria': 'وظایف فعال عامل',
