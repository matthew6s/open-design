...
export const zhCN: Dict = {
  ...
  "settings.modeDaemonHelp": "通过本机的代码智能体 CLI 执行",
  ...
  "settings.agentInstall.stepOpenLinks":
    "在目标智能体卡片上打开“安装”或“文档”链接。",
  "settings.agentInstall.stepAuth":
    "返回 OpenDesign 之前，请先在对应 CLI 中完成认证（登录或添加 API 凭据）。",
  "settings.agentInstall.stepRescan": "在此区域点击“重新扫描”。",
  "settings.agentInstall.stepSelect": "当智能体显示为已安装后，选择该智能体卡片。",
  "settings.noAgentsDetected":
    "尚未检测到任何智能体。请安装 Claude Code、Codex、OpenCode、Cursor Agent、Qwen 或 GitHub Copilot CLI 中的一个，然后点击「重新扫描」。",
  ...
  "settings.noAgentSelected": "尚未选择智能体",
  ...
  "settings.mcpServerHint":
    "将 OpenDesign 作为 MCP 服务器暴露给你的编码智能体。",
  ...
  "routines.errorAgentEmptyOutput":
    "智能体已完成运行但未产生任何输出。模型或提供商可能返回了空响应，请检查智能体日志中的上游错误。",
  ...
  "connectors.category.aiAgents": "AI 智能体",
  ...
  "newproj.dsNoneSubtitleSelected": "跳过体系 token，由智能体自行选择配色。",
  ...
  "newproj.dsNoneSub": "跳过体系 token，由智能体自行选择配色。",
  ...
  "avatar.noAgentSelected": "尚未选择智能体",
  ...
  "fileViewer.exportPptxHint": "请求智能体将此设计转换为 PPTX。",
  ...
  "assistant.statusBootingAgent": "正在启动智能体",
  ...
  "qf.ownAnswer": "自己填",
  "qf.required": "必填",
  "qf.lockedSubmitted": "答案已发送，智能体将在本次会话后续使用。",
  "qf.lockedPrev": "该表单来自此前的对话。",
  "qf.hint": "挑选合适的选项；可选项可以跳过，智能体会使用合理的默认值。",
  ...
  "critiqueTheater.settingsNavHint": "为智能体运行启用五人设计评审",
  "critiqueTheater.settingsEnabledLabel": "在智能体运行期间显示设计评审团",
  "critiqueTheater.settingsEnabledDescription":
    "启用后，五人评审面板会在智能体生成时同时显示，并在交付前对结果评分。你可以随时中断。",
