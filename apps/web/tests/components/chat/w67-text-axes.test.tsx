 ...
 *
 * ⚠️ 共享量尺的 `expand()` 是**属性白名单**:`line-height` / `font-family` /
 * `letter-spacing` 不在名单里,会被**静默丢掉**(读回 `<unset>`,和「真的没人写」
 * 分不开)。所以本文件一条 `line-height` / `font-family` 断言都不写 ——
 * 那两轴的差异只在交付报告里列,不在这里假装量过。
 *
